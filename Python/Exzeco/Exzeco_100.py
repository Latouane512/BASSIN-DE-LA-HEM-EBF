...
# --- 1. CONFIGURATION DU DISQUE (D:) ---
# On crée un dossier spécifique pour ne pas mélanger avec le 20 ans
...
if not layers:
    ...
    for i in range(iterations):
        ...
        # Étape B : Calcul de l'accumulation avec r.watershed
    ...
    if len(couches_valides) > 0:
        ...
        # Chargement automatique dans ton projet QGIS
